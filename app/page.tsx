                ...
                <div className={`${styles.container} items-center  md:block lg:flex`}> 
                  <div  className={`${styles.content} md:block items-center lg:flex `}> {/* Headline */} 
                    ...
                    <div className={styles.map}> 
                      <Image src="https://framerusercontent.com/images/ewZKWyEDBxGA5M6w17YPCdafro.png" alt="Map background" fill   style={{ objectFit: 'cover' }} priority  className='bg-cover bg-center z-[-1]'/> 
                    </div> 
                  </div> 
              </div>
            </div> 
                ...
                <div  className="bg-transparent xl:w-[407px] lg:h-[576px] md:h-[600px] rounded-lg shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl ">
                  <div className={`${styles.img3} px-7 py-6 flex justify-center items-center  `}>
                    <div className=''>
                      ...
                      <div className='backdrop-blur-sm px-5 py-3 mt-2 rounded-[20px] bg-black/33 xl:w-[359px] xl:h-[42px] lg:w-[350px] lg:h-[40px] md:w-[330px] md:h-[38px] w-[300px] h-[45px]'>
                      ...
                      <div className='backdrop-blur-sm px-5 py-3 mt-2 rounded-[20px] bg-black/33 xl:w-[359px] xl:h-[42px] lg:w-[350px] lg:h-[40px] md:w-[330px] md:h-[38px] w-[300px] h-[60px]'>
                        <div className="flex justify-start items-center">
                          <div className='flex justify-between items-center gap-2'>
                      ...
                      <div className='backdrop-blur-sm px-5 py-3 mt-2 rounded-[20px] bg-black/33 xl:w-[359px] xl:h-[42px] lg:w-[350px] lg:h-[40px] md:w-[330px] md:h-[38px] w-[300px] h-[40px]'>
                        <div className="flex justify-start items-center">
                          <div className='flex justify-between items-center gap-2'>
      ...
      <div className="flex flex-col items-start md:mt-12 mt-3 lg:mt-20 px-3 md:px-6">
        ...
        >
          {cardsDuo.map((card, index) => (
            <div key={index} className="flex-shrink-0 w-[120px]  flex justify-center items-center md:h-[144px] h-[113px] md:p-0 sm:p-0 p-3 md:w-[152px] rounded-[20px] bg-[#ffffff]/7">
