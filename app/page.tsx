      ...
      <div className="flex flex-col items-start md:mt-12 mt-3 lg:mt-20 px-3 md:px-6">
        ...
        >
          {cardsDuo.map((card, index) => (
            <div key={index} className="flex-shrink-0 w-[120px]  flex justify-center items-center md:h-[144px] h-[113px] md:p-0 sm:p-0 p-3 md:w-[152px] rounded-[5px] bg-[#ffffff]/7">
